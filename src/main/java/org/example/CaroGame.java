...
public class CaroGame {
    ...
    public static void main(String[] args) {
        ...
        for(int i =0;i<3;i++){
            ...
            System.out.println(availableCells.indexOf(humanInput));
            ...
            int machineSelect = availableCells.get(generateRandom(0, availableCells.size()-1));
    ...
    public static void selectCell(int cell,String player){
        /**
         * int colNum = (Integer.parseInt(cell)%3) -1;
         * int rowNum = (Integer.parseInt(cell)/3);
         */
        switch (cell){
            case 1: {
                board[0][0] = player;
